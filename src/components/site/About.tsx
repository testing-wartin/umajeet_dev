          ...
          <div className="grid items-center gap-10 md:grid-cols-2">
            <div className="border border-[#d9d9d9] rounded-3xl p-4 transition-all duration-300 hover:-translate-y-3 cursor-poi hover:shadow-[0_10px_10px_rgba(0.90,0.90,0.90,0.90)]">
              <img
                src={story.src}
                alt="Our story"
                className="rounded-2xl h-[328px] w-full object-cover"
              />
            </div>
            <div>
              ...
              <p className="mt-8 text-[20px] leading-[1.4] text-[#1a1a1a] text-justify tracking-[0.2px]">
                Umajeet Infratech Pvt. Ltd., established in 2025, is a forward-looking
                infrastructure and construction company committed to delivering high quality,
                sustainable, and innovative solutions in the rapidly evolving infrastructure sector.
                With a strong foundation built on integrity, excellence, and reliability, we provide
                end-to-end services in construction, infrastructure development, and consultancy.
              </p>
            </div>
          </div>
          {/* Our Vision */}
